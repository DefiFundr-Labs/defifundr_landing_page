...
import securePaymentsCard from "../../assets/images/secure_payments.png";
    ...
    <div className="container flex flex-col-reverse items-center justify-between gap-10 lg:flex-row">
      <div className="flex justify-center ">
        <img
          ...
          className="object-cover mt-5 transition duration-200 ease-linear rounded-lg shadow-2xl max-w-xl transform-gpu hover:scale-105 max-h-[30.3rem]"
        />
      </div>
